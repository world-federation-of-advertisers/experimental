	...
	duchy_pod: {
		...
		"liquid-legions-v2-mill-daemon-pod": #Pod & {
			_args: [
				...
				"--polling-interval=1s",
				"--noise-config-file=/app/wfa_measurement_system/src/main/kotlin/org/wfanet/measurement/duchy/deploy/common/daemon/mill/liquidlegionsv2/config/liquid_legions_v2_noise_config.textproto",
			] + _computation_control_service_flags + _blob_storage_flags
			_jvm_flags: "-Xmx1g -Xms256m"
