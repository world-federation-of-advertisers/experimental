...
#ifndef SRC_MAIN_CC_WFA_ANY_SKETCH_EXPONENTIAL_INDEX_FUNCTION_H_
#define SRC_MAIN_CC_WFA_ANY_SKETCH_EXPONENTIAL_INDEX_FUNCTION_H_
...
// ExponentialIndexFunction maps the output of a HashFunction to a coordinate
// using exponential distribution with param rate and multiplies the output with
// param size.
class ExponentialIndexFunction : public IndexFunction {
 public:
  ...
  ExponentialIndexFunction& operator=(ExponentialIndexFunction&& other) =
      default;
...
#endif  // SRC_MAIN_CC_WFA_ANY_SKETCH_EXPONENTIAL_INDEX_FUNCTION_H_
